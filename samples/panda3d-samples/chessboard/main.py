...
class MainApp(ShowBase):
    def __init__(self):
        ...
        """)
        pipeline_path = "C:\\Users\\xnick\\Downloads\\render_pipeline"
        ...
        # Set time of day
        self.render_pipeline.daytime_mgr.time = .7
        ...
        #textNode.node().setTag("sctest1", "1")
        ...
        textNode.getChild(0).node().setIntoCollideMask(BitMask32.bit(1))
        textNode.setScale(50, 10, 50)
        camera.setPosHpr(228, -394, 233, 28, -27, 13)
        # Visualize the collisions
        self.picker.showCollisions(render)

        # Traverse from render rather than self.squareRoot
        self.picker.traverse(render)#self.squareRoot)
        # Comment out the if block after the traverse
        
        fromObject = textNode.attachNewNode(CollisionNode('colNode'))
        #fromObject.show()
